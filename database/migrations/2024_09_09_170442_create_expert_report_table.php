...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('expert_report', function (Blueprint $table) {
            ...
            $table->string("ExpertReportDamage");
            $table->bigInteger("ExpertReportFixedPrice");
            $table->bigInteger("ExpertReportFixedPartsPrice");
            $table->string("ExpertReportComment");
